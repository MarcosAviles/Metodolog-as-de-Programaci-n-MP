...
/**
@brief realiza la animacion de apagado y encendimo de una secuencia de LEDs
@param b el @c bloqueLed que se quiere animar
*/
void ejemplo1(bloqueLed b);

/**
@brief realiza la animacion de apagado y encendido de una secuencia de LEDs
@param b @c bloqueLed que se quiere animar
*/
